    ...
    return (
      ...
      <div className={classes.paperLessMargin}>
        ...
        {profilePic !== null ? (
            ...
            <Image src={profilePic} alt="ProfilePic" roundedCircle style={{borderRadius:"50%"}} height="200px" width="200px" />     
            ) 
            :  <Image src={"https://st.depositphotos.com/1052233/2885/v/950/depositphotos_28850541-stock-illustration-male-default-profile-picture.jpg"} alt="ProfilePic" roundedCircle style={{borderRadius:"50%"}} height="200px" width="200px" />
