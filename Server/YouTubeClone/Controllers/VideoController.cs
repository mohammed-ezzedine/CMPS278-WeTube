    ...
    public class VideoController : ControllerBase
    {
        ...
        public async Task<ActionResult<VideoDto>> GetVideo(int id)
        {
            var videoById = await context.Video
                ...
                .Include(v => v.UserVideoReactions)
                .ThenInclude(r => r.User)
                .Include(v => v.UserVideoComments).ThenInclude(v => v.User)
                .Include(v => v.UserVideoComments).ThenInclude(c => c.UserCommentReplies)
                .Include(v => v.UserVideoComments).ThenInclude(c => c.UserCommentReactions)
                .ThenInclude(r => r.User)
                .Include(v => v.UserVideoViews)
                .ThenInclude(v => v.User)
